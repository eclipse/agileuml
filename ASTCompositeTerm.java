...
{ String tag = ""; 
  ...
  { System.out.println(">> jsstatementToKM3 for " + tag + " with " + terms.size() + " terms"); 
    ...
    { Vector bfs = jsfunctionDeclarationToKM3(
      ...
      CreationStatement cre = 
         new CreationStatement(bfvar,bf.getFunctionType()); 
      AssignStatement asgn = 
  ...
  { System.out.println(">> jsfeatureAccess for " + tag + " with " + terms.size() + " terms " + obj + "." + feature + pars); 
    ...
    if ("Array".equals(obj + "") && "of".equals(feature) &&
        pars.size() > 0) 
  ...
  { // Testing of JS to KM3
    ...
    File fcstl = new File("./cg/JS2UML.cstl");   
    if (fcstl != null) 
    { spec = CSTL.loadCSTL(fcstl,new Vector(),new Vector()); } 

    if (spec == null) 
    { System.err.println("!! Error: No cg/JS2UML.cstl file defined!"); 
      return; 
    } 

    String cgtext = xx.cg(spec); 

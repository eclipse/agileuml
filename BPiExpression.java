...
public class BPiExpression extends BExpression
{ private String var;
  private BExpression pred;
  private BExpression value;
  // PI(var).(pred | value)

  public BPiExpression(String v, BExpression p,
                          BExpression val)
  { var = v;
    pred = p;
    value = val;
  ...
  { BExpression p2 = pred.simplify(); 
    ...
    return new BPiExpression(var,p2,v2); 
  } 
  ...
  { if (var.equals(oldE)) { return this; } 
    ...
    return new BPiExpression(var,npred,nval); 
  } 
}

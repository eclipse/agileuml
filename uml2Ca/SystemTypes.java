...
public interface SystemTypes
{
  ...
  public static List select_0(List _l,Entity entityx)
  { // Implements: superclass.any.inheritedOperations()->select(p | p.name /: superclass.any.ownedOperation.name)
    List _results_0 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { Operation p = (Operation) _l.get(_i);
      if (!(Operation.getAllOrderedname(((Entity) Set.any(entityx.getsuperclass())).getownedOperation()).contains(p.getname())))
      { _results_0.add(p); }
    }
    return _results_0;
  }

  public static Map select_0(Map _l,Entity entityx)
  { // Implements: superclass.any.inheritedOperations()->select(p | p.name /: superclass.any.ownedOperation.name)
    Map _results_0 = new java.util.HashMap();
  ...
  { // Implements: members->select(cmember_2_xx | name = "super")
    List _results_2 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember cmember_2_xx = (CMember) _l.get(_i);
      if (((String) cmember_2_xx.getname()).equals("super"))
      { _results_2.add(cmember_2_xx); }
    }
    return _results_2;
  }

  public static Map select_2(Map _l)
  { // Implements: members->select(cmember_2_xx | name = "super")
    Map _results_2 = new java.util.HashMap();
    java.util.Set _keys = _l.keySet();
    for (Object _i : _keys)
    { CMember cmember_2_xx = (CMember) _l.get(_i);
      if (((String) cmember_2_xx.getname()).equals("super"))
      { _results_2.put(_i, cmember_2_xx); }
    }
    return _results_2;
  }
  ...
  { // Implements: allMembers->select(cmember_4_xx | isKey)
    List _results_4 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember cmember_4_xx = (CMember) _l.get(_i);
      if (cmember_4_xx.getisKey())
      { _results_4.add(cmember_4_xx); }
    }
    return _results_4;
  }

  public static Map select_4(Map _l)
  { // Implements: allMembers->select(cmember_4_xx | isKey)
    Map _results_4 = new java.util.HashMap();
    java.util.Set _keys = _l.keySet();
    for (Object _i : _keys)
    { CMember cmember_4_xx = (CMember) _l.get(_i);
      if (cmember_4_xx.getisKey())
      { _results_4.put(_i, cmember_4_xx); }
    }
    return _results_4;
  }
  ...
  public static boolean exists_3(List _l)
  ...
  public static boolean exists_5(List _l, CStruct cstructx)
  ...
  public static boolean exists_6(List _l, CStruct cstructx)
  ...
  public static boolean exists_7(List _l, CStruct cstructx)
  ...
  public static boolean exists_13(List _l)
  ...
  { // Implements: BinaryExpression->exists(be|be.operator = "->isUnique" & be.left.elementType.name = name)
    for (int _i = 0; _i < _l.size(); _i++)
    { BinaryExpression be = (BinaryExpression) _l.get(_i);
      if (((String) be.getoperator()).equals("->isUnique") && ((String) be.getleft().getelementType().getname()).equals(cstructx.getname())) { return true; }
    }
    return false;
  }

  public static boolean exists_16(List _l, CStruct cstructx)
  { // Implements: UnaryExpression->exists(be|be.operator = "->asSet" & be.argument.elementType.name = name)
    for (int _i = 0; _i < _l.size(); _i++)
    { UnaryExpression be = (UnaryExpression) _l.get(_i);
      if (((String) be.getoperator()).equals("->asSet") && ((String) be.getargument().getelementType().getname()).equals(cstructx.getname())) { return true; }
    }
    return false;
  }
  ...
  { // implements: subclasses->collect( sb | sb.allSubclasses() )
    List _results_1 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { Entity sb = (Entity) _l.get(_i);
      List collect_x = sb.allSubclasses();
  ...
  public static List collect_17(List _l,String ent,String sup)
  { // implements: anc.members->collect( m | m.inheritedGetterOpDec(ent,sup) )
    List _results_17 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedGetterOpDec(ent,sup);
      if (collect_x != null) { _results_17.add(collect_x); }
    }
    return _results_17;
  }

  public static Map collect_17(Map _l,String ent,String sup)
  { // implements: anc.members->collect( m | m.inheritedGetterOpDec(ent,sup) )
    Map _results_17 = new HashMap();
    java.util.Set _keys = _l.keySet();
    for (Object _i : _keys)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedGetterOpDec(ent,sup);
      if (collect_x != null) { _results_17.put(_i,collect_x); }
    }
    return _results_17;
  }

  public static List collect_18(List _l,String ent,CType sup)
  { // implements: sup.members->collect( m | m.inheritedGetterOpDec(ent,sup.name) )
    List _results_18 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedGetterOpDec(ent,((CStruct) sup).getname());
      if (collect_x != null) { _results_18.add(collect_x); }
    }
    return _results_18;
  }

  public static Map collect_18(Map _l,String ent,CType sup)
  { // implements: sup.members->collect( m | m.inheritedGetterOpDec(ent,sup.name) )
  ...
  public static List collect_19(List _l,String ent,String sup)
  { // implements: anc.members->collect( m | m.inheritedSetterOpDec(ent,sup) )
    List _results_19 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedSetterOpDec(ent,sup);
      if (collect_x != null) { _results_19.add(collect_x); }
    }
    return _results_19;
  }

  public static Map collect_19(Map _l,String ent,String sup)
  { // implements: anc.members->collect( m | m.inheritedSetterOpDec(ent,sup) )
  ...
  public static List collect_20(List _l,String ent,CType sup)
  { // implements: sup.members->collect( m | m.inheritedSetterOpDec(ent,sup.name) )
    List _results_20 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedSetterOpDec(ent,((CStruct) sup).getname());
      if (collect_x != null) { _results_20.add(collect_x); }
    }
    return _results_20;
  }

  public static Map collect_20(Map _l,String ent,CType sup)
  { // implements: sup.members->collect( m | m.inheritedSetterOpDec(ent,sup.name) )
  ...
  public static List collect_21(List _l,String ent,String sup)
  { // implements: anc.members->collect( m | m.inheritedAllOpDec(ent,sup) )
    List _results_21 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedAllOpDec(ent,sup);
      if (collect_x != null) { _results_21.add(collect_x); }
    }
    return _results_21;
  }

  public static Map collect_21(Map _l,String ent,String sup)
  { // implements: anc.members->collect( m | m.inheritedAllOpDec(ent,sup) )
  ...
  public static List collect_22(List _l,String ent,CType sup)
  { // implements: sup.members->collect( m | m.inheritedAllOpDec(ent,sup.name) )
    List _results_22 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CMember m = (CMember) _l.get(_i);
      String collect_x = m.inheritedAllOpDec(ent,((CStruct) sup).getname());
      if (collect_x != null) { _results_22.add(collect_x); }
    }
    return _results_22;
  }

  public static Map collect_22(Map _l,String ent,CType sup)
  { // implements: sup.members->collect( m | m.inheritedAllOpDec(ent,sup.name) )
  ...
  public static List collect_23(List _l)
  { // implements: ownedLiteral->collect( x | ", " + x.name )
    List _results_23 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { CEnumerationLiteral x = (CEnumerationLiteral) _l.get(_i);
      String collect_x = ", " + x.getname();
      if (collect_x != null) { _results_23.add(collect_x); }
    }
    return _results_23;
  }

  public static Map collect_23(Map _l)
  { // implements: ownedLiteral->collect( x | ", " + x.name )

...
public interface MathOCLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MathOCLParser#instruction}.
	 * @param ctx the parse tree
	 */
	void enterInstruction(MathOCLParser.InstructionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MathOCLParser#instruction}.
	 * @param ctx the parse tree
	 */
	void exitInstruction(MathOCLParser.InstructionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MathOCLParser#substituteIn}.
	 * @param ctx the parse tree
	 */
	void enterSubstituteIn(MathOCLParser.SubstituteInContext ctx);
	/**
	 * Exit a parse tree produced by {@link MathOCLParser#substituteIn}.
	 * @param ctx the parse tree
	 */
	void exitSubstituteIn(MathOCLParser.SubstituteInContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MathOCLParser#expressAs}.
	 * @param ctx the parse tree
	 */
	void enterExpressAs(MathOCLParser.ExpressAsContext ctx);
	/**
	 * Exit a parse tree produced by {@link MathOCLParser#expressAs}.
	 * @param ctx the parse tree
	 */
	void exitExpressAs(MathOCLParser.ExpressAsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MathOCLParser#cancelIn}.
	 * @param ctx the parse tree
	 */
	void enterCancelIn(MathOCLParser.CancelInContext ctx);
	/**
	 * Exit a parse tree produced by {@link MathOCLParser#cancelIn}.
	 * @param ctx the parse tree
	 */

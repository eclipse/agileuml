...
{ private JPanel bottom;
  ...
  public EISUseCaseDialog(JFrame owner)
  { super(owner, true);
    setTitle("Define EIS Use Case");
    okButton = new JButton("Ok");
    cancelButton = new JButton("Cancel");
    EISButtonHandler bHandler = new EISButtonHandler();
    ...
    dialogPanel = new EISUCDialogPanel();
  ...
  { nameLabel.setBounds(10,10,130,30);
    ...
    // extendsLabel.setBounds(10,110,130,30); 
    // extendsField.setBounds(140,115,270,20); 
